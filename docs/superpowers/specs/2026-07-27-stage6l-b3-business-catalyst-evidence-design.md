...
阶段 6L-B3 建立独立、可追溯、可证伪的主营与催化关联研究合同。首版接受
交易所或指定披露平台官方披露，以及基于官方材料形成的版本化人工审核映射。
公司官网材料须等待与证券身份绑定的版本化域名名册，当前不能由调用方自行
声明域名后直接准入。
...
- 交易所或指定披露平台发布的上市公司年报、半年报和正式公告；
- 上海或深圳证券交易所正式披露；
- 巨潮资讯等交易所指定信息披露平台的公司原文；
- 具有明确版本、审核时间和官方引用材料的人工审核映射。

公司官网和公司 IR 材料属于后续待接来源；只有版本化域名名册与证券身份
绑定并通过独立验收后才能准入，当前保持 `source_unverified`。
